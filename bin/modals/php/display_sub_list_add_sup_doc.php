...
?>
                <div class="pl-4 mb-2 item_cont">
                    <input class="form-check-input" type="checkbox" id="sub_support_doc<?php echo $doc[0];?>" name="sub_support_doc[]" value="<?php echo $doc[0];?>"
                    <?php
                    ...
                    ?>
                    >
                    <input type="hidden" name="sub_office[]" id="sub_office" value="<?php echo $doc[2];?>">
                    <input type="hidden" name="sub_support_doc_name[]" id="sub_support_doc_name" value="<?php echo $doc[0];?>">
                    <label class="form-check-label" for="sub_support_doc<?php echo $doc[0];?>"><span class="text-secondary" style="font-weight: bold;"><?php echo $doc[4];?></span> | <?php echo $doc[3];?></label>
                </div>
<?php
            }
        }
