...
?>
                            <span id="uncheck_supdoc" style="margin-left:-20px; cursor:default" ins-id="<?php echo $ins_id;?>" scode="<?php echo $doc[1];?>" offccode="<?php echo $doc[2];?>">
...
?>
                            <input class="form-check-input" type="checkbox" id="up_support_doc<?php echo $doc[0];?>" name="support_doc[]" value="<?php echo $doc[0];?>">
                            <label class="form-check-label" for="up_support_doc<?php echo $doc[0];?>"><span class="text-secondary" style="font-weight: bold;"><?php echo $doc[4];?></span> | <?php echo $doc[3];?></label>
<?php
                        }
                    ?>
                    <input type="hidden" name="office[]" id="up_office" value="<?php echo $doc[2];?>">
                    <input type="hidden" name="support_doc_name[]" id="up_support_doc_name" value="<?php echo $doc[0];?>">
                </div>
<?php
            }
        }
