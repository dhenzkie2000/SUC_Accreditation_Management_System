                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <form id="add_sub_param_form" enctype="multipart/form-data">
                                    <div class="row">
                                        <input type="hidden" id="sub_add_timezone" name="add_timezone" readonly>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <div class="input-group">
                                                        <span class="input-group-append ar_num" id="sub_ar_num"></span>
                ...
                <div id="AddModal" class="modal fade" role="dialog">
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                            <form id="add_param_form" enctype="multipart/form-data">
                                    <div class="row">
                                        <input type="hidden" id="add_timezone" name="add_timezone" readonly>
                                        <input type="hidden" name="add_area_id" id="add_area_id" readonly>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-lg" name="add_param_code" id="add_param_code" style="text-transform: uppercase;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Short Definition</label>
                                                <div>
                                                    <input type="text" class="form-control input-lg" name="add_param_def" id="add_param_def" maxlength="15" style="text-transform: uppercase;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Description</label>
                                                <div>
                                                    <textarea class="form-control w-100" rows="15" name="add_param_desc" id="add_param_desc" style="resize: none; text-transform: uppercase;" maxlength="60"></textarea>
                                                </div>
                                            </div>
                                        </div> 
                                    </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-primary btn-icon-split" id="add_param_btn" type="submit">
                                    <span class="icon text-white-50">
                                        <i class="fas fa-plus"></i>
                                    </span>
                                    <span class="text">Submit</span>
                ...
                <div id="UpdateModal" class="modal fade" role="dialog">
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <form id="update_form">
                                    <div class="row">
                                        <input type="hidden" name="up_area_id" id="up_area_id" readonly>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Short Definition</label>
                                                <div>
                                                    <input type="text" class="form-control input-lg" name="up_area_def" id="up_area_def" maxlength="15" style="text-transform: uppercase;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Description</label>
                                                <div>
                                                    <textarea class="form-control w-100" rows="15" name="up_area_desc" id="up_area_desc" style="resize: none; text-transform: uppercase;" maxlength="200"></textarea>
                                                </div>
                                            </div>
                                        </div> 
                                    </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-info btn-icon-split" id="up_area_btn" type="submit">
                                    <span class="icon text-white-50">
                ...
                <div id="ParamUpdateModal" class="modal fade" role="dialog">
                    <div class="modal-dialog modal-lg">
                        <!-- Add modal content start-->
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                            <form id="update_param_form">
                                    <div class="row">
                                        <input type="hidden" name="up_param_id" id="up_param_id" readonly>
                                        <input type="hidden" name="up_param_area_id" id="up_param_area_id" readonly>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Parameter Code</label>
                                                <div>
                                                    <div class="input-group">
                                                        <span class="input-group-append ar_num" id="up_ar_num"></span>
                                                        <input type="text" class="form-control input-lg" name="up_param_code" id="up_param_code" style="text-transform: uppercase;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Short Definition</label>
                                                <div>
                                                    <input type="text" class="form-control input-lg" name="up_param_def" id="up_param_def" maxlength="15" style="text-transform: uppercase;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Description</label>
                                                <div>
                                                    <textarea class="form-control w-100" rows="15" name="up_param_desc" id="up_param_desc" style="resize: none; text-transform: uppercase;" maxlength="60"></textarea>
                                                </div>
                                            </div>
                                        </div> 
                                    </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control input-lg" name="up_param_code" id="up_ins_code" style="text-transform: uppercase;" maxlength="6">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Description</label>
                                                <div>
                                                    <textarea class="form-control w-100" rows="15" name="up_param_desc" id="up_ins_desc" style="resize: none;" maxlength="300"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-primary btn-icon-split" id="up_ins_btn" type="submit">
                                    <span class="icon text-white-50">
                                        <i class="fas fa-plus"></i>
                                    </span>
                                    <span class="text">Submit</span>
