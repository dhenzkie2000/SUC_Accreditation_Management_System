...
include "includes/categories_inc.php";
?>
...
<body>
    ...
    <div id="wrapper">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapsettings" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="#">Category</a>
                        </div>
                    </div>
                </li>
       ...
       <!-- Start Modals -->
<?php
           include "includes/category_modals.php";     
?>
        <!-- End Modals -->
                <div id="content">
                    <!-- NavBar Start -->
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <h5><span style="font-weight: bold;">Settings</span> | Category</h5>
<?php
                    ...
                    <div class="row px-3">
                        <div class="col-lg-9">
                            <div class="card mb-5">
                                ...
                                <div class="card-body">
<?php
                                include "includes/category_inc_table.php";
?>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="card mb-3" id="sc_add">
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold text-secondary">Add Category</h6>
                                </div>
                                <div class="card-body">
                                    <form id="add_form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="cat_code" name="cat_code" maxlength="1" style="text-transform: uppercase;">
                                        </div>
                                        <div class="form-group">
                                            <label for="cat_desc">Category Description:</label>
                                            <textarea class="form-control w-100" rows="15" name="cat_desc" id="cat_desc" style="resize: none; text-transform: uppercase;"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="cat_plac">Category Placement:</label>
                                            <input type="number" class="form-control" id="cat_plac" name="cat_plac" maxlength="3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
...
<script type="text/javascript" src="modals/js/categories.js"></script>
<?php
